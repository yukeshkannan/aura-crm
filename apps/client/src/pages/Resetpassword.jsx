...
import { Lock, ChevronRight, Sparkles, KeyRound } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-stone-50 font-sans relative overflow-hidden">
            ...
            >
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-stone-400 text-lg font-medium max-w-md leading-relaxed">
                        Create a strong password to keep your data safe and secure.
                    </p>
                </div>

                <div className="relative z-10 flex gap-12 border-t border-white/10 pt-10">
                   <div>
                      <p className="text-white font-black text-3xl tracking-tight">Encrypted</p>
                      <p className="text-stone-500 text-xs font-bold uppercase tracking-widest mt-1">Data</p>
                   </div>
                   <div>
                      <p className="text-white font-black text-3xl tracking-tight">24/7</p>
                      <p className="text-stone-500 text-xs font-bold uppercase tracking-widest mt-1">Protection</p>
                   </div>
                </div>
            </motion.div>
            ...
            <div className="flex items-center justify-center p-8 lg:p-16 relative">
                ...
                >
                    <div className="mb-12">
                        <h2 className="text-4xl font-black text-stone-900 mb-3 tracking-tight">Reset Password 🔑</h2>
                        <p className="text-stone-500 font-medium text-lg">Enter the code sent to your email and your new password.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-black text-stone-400 uppercase tracking-widest ml-1">OTP Code</label>
                            <div className="relative group">
                                <KeyRound className="absolute left-5 top-1/2 -translate-y-1/2 text-stone-300 group-focus-within:text-amber-600 transition-colors" size={20} />
                                <input 
                                    type="text" 
                                    value={otp}
                                    onChange={(e) => setOtp(e.target.value)}
                                    required
                                    className="w-full pl-14 pr-6 py-4 bg-white border border-stone-200 rounded-2xl outline-none focus:border-amber-500 focus:ring-4 focus:ring-amber-500/10 transition-all font-medium text-stone-900 placeholder:text-stone-300 shadow-sm tracking-widest"
